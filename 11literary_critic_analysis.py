...
# frequency = wordCount / length of list
...
'''
print( "Neruda's word use" )
litCricFriend( [], cantoXII )

print( "Poe's word use" )
litCricFriend( [], theBells )

# Poe's indefinite frequency / Neruda's indefinite frequency: 16.6% to 5.9%
# Poe's definite frequency / Neruda's definte frequency: 4% to 0.07%
# Please forgive excessive output